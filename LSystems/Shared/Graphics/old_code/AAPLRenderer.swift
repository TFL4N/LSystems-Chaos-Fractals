...
class AAPLRenderer: NSObject, MTKViewDelegate {
    ...
    init?(metalKitView: MTKView) {
        ...
        do {
            mesh = try AAPLRenderer.buildMesh(device: device, mtlVertexDescriptor: mtlVertexDescriptor)
        } catch {
        ...
        do {
            colorMap = try AAPLRenderer.loadTexture(device: device, textureName: "ColorMap")
        } catch {
    ...
    class func buildMesh(device: MTLDevice,
        ...
        guard let attributes = mdlVertexDescriptor.attributes as? [MDLVertexAttribute] else {
            throw AAPLRendererError.badVertexDescriptor
        }
